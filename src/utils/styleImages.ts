...
function starryNight(ctx: CanvasRenderingContext2D, w: number, h: number): void {
...
function greatWave(ctx: CanvasRenderingContext2D, w: number, h: number): void {
...
function theScream(ctx: CanvasRenderingContext2D, w: number, h: number): void {
...
function mosaic(ctx: CanvasRenderingContext2D, w: number, h: number): void {
  const colors: string[] = ['#8d6e63', '#a1887f', '#d7ccc8', '#795548', '#5d4037', '#efebe9', '#4e342e', '#bcaaa4', '#c62828', '#1565c0', '#2e7d32', '#f9a825']
  const tileSize = 8
...
export function getStyleImages(): Record<string, string> {
