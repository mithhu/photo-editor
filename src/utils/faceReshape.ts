...
import type { FaceKeypoint, ReshapeSettings } from '../types'
 ...
 */
export function applyReshapeToImageData(
  srcData: ImageData,
  keypoints: FaceKeypoint[],
  settings: ReshapeSettings
): ImageData {
