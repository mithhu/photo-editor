...
const SUGGESTION_TO_PRESET: Record<string, string> = {
  bright: 'vivid',
  hdr: 'dramatic',
  cinematic: 'cinematic',
  matte: 'fade',
...
export function suggestFilters(canvas: HTMLCanvasElement): FilterSuggestion[] {
  ...
  const suggestions: { filter: string; reason: string; confidence: number }[] = []
