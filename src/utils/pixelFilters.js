...
export function applySaturate(r, g, b, amount) {
...
export function applyGrayscale(r, g, b, amount) {
  const gray = 0.2126 * r + 0.7152 * g + 0.0722 * b
  return [
...
export function applyHueRotate(r, g, b, degrees) {
 ...
 */
export function applyPixelFilters(imgData, ops) {
