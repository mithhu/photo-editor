import type { TiltShift } from '../types'
 ...
 */
export function applyTiltShift(ctx: CanvasRenderingContext2D, canvasW: number, canvasH: number, params: TiltShift): void {
...
function boxBlurH(data: Uint8ClampedArray, w: number, h: number, radius: number): void {
...
function boxBlurV(data: Uint8ClampedArray, w: number, h: number, radius: number): void {
