...
export const FACE_STICKER_CATEGORIES: StickerCategory[] = [
  {
    ...
    label: 'Glasses',
    stickers: [
      { id: 'sunglasses', label: 'Sunglasses', emoji: '🕶️', anchor: 'eyes', offsetY: 0.05, scale: 2.0 },
      { id: 'nerd-glasses', label: 'Nerd', emoji: '🤓', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'monocle', label: 'Monocle', emoji: '🧐', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'glasses-round', label: 'Round', emoji: '👓', anchor: 'eyes', offsetY: 0.05, scale: 2.0 },
      { id: 'disguise', label: 'Disguise', emoji: '🥸', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
    ],
  },
  {
    id: 'headwear',
    label: 'Headwear',
    stickers: [
      { id: 'crown', label: 'Crown', emoji: '👑', anchor: 'forehead', offsetY: -0.45, scale: 1.5 },
      { id: 'top-hat', label: 'Top Hat', emoji: '🎩', anchor: 'forehead', offsetY: -0.5, scale: 1.5 },
      { id: 'cowboy', label: 'Cowboy', emoji: '🤠', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'party-hat', label: 'Party', emoji: '🥳', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'halo', label: 'Halo', emoji: '😇', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'horns', label: 'Devil Horns', emoji: '😈', anchor: 'full-face', offsetY: -0.05, scale: 1.2 },
      { id: 'helmet', label: 'Helmet', emoji: '⛑️', anchor: 'forehead', offsetY: -0.4, scale: 1.6 },
      { id: 'cap', label: 'Cap', emoji: '🧢', anchor: 'forehead', offsetY: -0.45, scale: 1.5 },
    ],
  },
  {
    id: 'decorations',
